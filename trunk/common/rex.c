...
SCClString regular_expressions = { 0 , 0 , 0 } ;
SCClString object_string = { 0 , 0 , 0 } ;
SCClString pattern_elements_matched = { 0 , 0 , 0 } ;
...
void _string_initialize ( SCClString* string , char* ddata ) {
...
void _string_initialize_with_length ( SCClString* string , int llength ) {
...
void _string_add( SCClString* string , char element ) {
...
char _string_get( SCClString string ) {
...
int _string_overflowed( SCClString string ) {
...
void _string_next( SCClString* string ) {
...
void _string_destroy( SCClString* string ) {
...
char _string_look( SCClString string , int step ) {
...
void _string_walker_add ( SCClString* string , int step ) {
...
void _string_reset_walker_with_element ( SCClString* string , char element ) {
...
void _string_add_token( SCClString* string , char* token ) {

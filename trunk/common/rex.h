...
extern SCClString regular_expressions ;
extern SCClString object_string ;
extern SCClString pattern_elements_matched ;
...
extern void _string_initialize ( SCClString* string , char* ddata ) ;
extern void _string_initialize_with_length ( SCClString* string , int llength ) ;
extern void _string_add( SCClString* string , char element ) ;
extern char _string_get( SCClString string ) ;
extern int _string_overflowed( SCClString string ) ;
extern void _string_next( SCClString* string ) ;
extern void _string_destroy( SCClString* string ) ;
extern char _string_look( SCClString string , int step ) ;
extern void _string_walker_add ( SCClString* string , int step ) ;
extern void _string_reset_walker_with_element ( SCClString* string , char element ) ;
extern void _string_add_token( SCClString* string , char* token ) ;
